<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DemoSuggestFree.aspx.cs" Inherits="SuggestFree_ASPNET.DemoVerify" %>
...
L'end point della libreria da includere nella sezione js di inizializzazione nella pagina è 
    https://streetmaster.streetmaster.it/suggest/js/1.0/suggest_free.js
...
<head runat="server">
    ...
    <script type="text/javascript" src="https://streetmaster.streetmaster.it/suggest/js/1.2/suggest_free.js"></script>
...
<body bgcolor="#E6E6FA">
    <form id="DemoSuggestFree" runat="server">
        ...
        <p>
            ATTENZIONE  
            <br />
            Prima dell'utilizzo valorizzare la chiave del servizio SUGGEST Free nella sezione dichiarativa JS della pagina
            &nbsp;
        </p>
    </form>
</body>
